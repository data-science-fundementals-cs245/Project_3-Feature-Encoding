...
# for VLAD_DIR in os.listdir(ROOT_DIR):
VLAD_DIR = "VLAD128"
print("Loading for fisher vectors: %s" %VLAD_DIR)

whole_data = []
lable_data = []

for i, sample_file in enumerate(os.listdir(os.path.join(ROOT_DIR, VLAD_DIR))):
    sample_f = h5py.File(os.path.join(ROOT_DIR, VLAD_DIR, sample_file)) 
